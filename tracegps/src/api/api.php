...
{   
    ...
    // Ce service permet à un utilisateur de s'authentifier
    private function Connecter()
    {   include_once ("services/Connecter.php");
    }
    
    // Ce service permet à un utilisateur de changer son mot de passe
    private function ChangerDeMdp()
    {   include_once ("services/ChangerDeMdp.php");
    }
    
    // Ce service permet à un utilisateur de se créer un compte
